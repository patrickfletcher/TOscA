...
%             points(i).min.x(j)=xmin;
        ...
        Fdist(i).f1=(points(i).max.t-points(i).up.t)./Fdist(i).period; %up2max time
        Fdist(i).f2=(points(i).down.t-points(i).max.t)./Fdist(i).period; %max2down time
        Fdist(i).f3=(points(i).min.t(2:end)-points(i).down.t)./Fdist(i).period; %down2min time
        Fdist(i).f4=(points(i).up.t-points(i).min.t(1:end-1))./Fdist(i).period; %min2up time
        Fdist(i).amp=amp;
